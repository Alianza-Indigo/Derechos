...
import { getConfiguration, getUserName } from "@/server/queries/app";
...
export default async function ConfigurationPage() {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader title="Configuracion institucional" description="Nombre, razon social, logotipo, colores, pais base, IA y geolocalizacion son editables sin alterar arquitectura." />
      ...
      <Card>
        <CardHeader title="Retencion y privacidad de ubicacion" />
